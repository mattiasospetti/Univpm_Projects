...
TT=timetable(timestamp(1:1970), matrice(round(array*143/257):array,1));
TT=renamevars(TT,["Var1"],["acc_x"]);
TT2=timetable(timestamp(1:1970),matrice(round(array*143/257):array,2));
TT3=timetable(timestamp(1:1970),matrice(round(array*143/257):array,3));
TT4=timetable(timestamp(1:1970),matrice(round(array*143/257):array,4));
TT5=timetable(timestamp(1:1970),matrice(round(array*143/257):array,5));
TT6=timetable(timestamp(1:1970),matrice(round(array*143/257):array,6));
TT7=timetable(timestamp(1:1970),matrice(round(array*143/257):array,7));
TT8=timetable(timestamp(1:1970),matrice(round(array*143/257):array,8));
TT9=timetable(timestamp(1:1970),matrice(round(array*143/257):array,9));
...
TT10=timetable(timestamp(1:1970), matrice(round(array*143/257):array,10));
TT11=timetable(timestamp(1:1970), matrice(round(array*143/257):array,11));
TT12=timetable(timestamp(1:1970), matrice(round(array*143/257):array,12));
TT13=timetable(timestamp(1:1970), matrice(round(array*143/257):array,13));
TT14=timetable(timestamp(1:1970), matrice(round(array*143/257):array,14));
TT15=timetable(timestamp(1:1970), matrice(round(array*143/257):array,15));
...
TT16=timetable(timestamp(round(array*143/257):array), matrice(round(array*143/257):array,16));
...
TT17=timetable(timestamp(1:1970), matrice(round(array*143/257):array,17));
TT18=timetable(timestamp(1:1970), matrice(round(array*143/257):array,18));
TT19=timetable(timestamp(1:1970), matrice(round(array*143/257):array,19));
...
TT20=timetable(timestamp(1:1970), matrice(round(array*143/257):array,20));
TT21=timetable(timestamp(1:1970), matrice(round(array*143/257):array,21));
TT22=timetable(timestamp(1:1970), matrice(round(array*143/257):array,22));
...
TT23=timetable(timestamp(round(array*143/257):array), matrice(round(array*143/257):array,23));
...
TT24=timetable(timestamp(1:1970),matrice(round(array*143/257):array,24));
TT25=timetable(timestamp(1:1970),matrice(round(array*143/257):array,25));
TT26=timetable(timestamp(1:1970),matrice(round(array*143/257):array,26));
TT27=timetable(timestamp(1:1970),matrice(round(array*143/257):array,27));
TT28=timetable(timestamp(1:1970),matrice(round(array*143/257):array,28));
TT29=timetable(timestamp(1:1970),matrice(round(array*143/257):array,29));
...
TT30=timetable(timestamp(1:1970),matrice(round(array*143/257):array,30));
TT31=timetable(timestamp(1:1970),matrice(round(array*143/257):array,31));
TT32=timetable(timestamp(1:1970),matrice(round(array*143/257):array,32));
TT33=timetable(timestamp(1:1970),matrice(round(array*143/257):array,33));
TT34=timetable(timestamp(1:1970),matrice(round(array*143/257):array,34));
TT35=timetable(timestamp(1:1970),matrice(round(array*143/257):array,35));
TT36=timetable(timestamp(1:1970),matrice(round(array*143/257):array,36));
TT37=timetable(timestamp(1:1970),matrice(round(array*143/257):array,37));
...
TT38=timetable(timestamp(1:1970),matrice(round(array*143/257):array,38));
TT39=timetable(timestamp(1:1970),matrice(round(array*143/257):array,39));
TT40=timetable(timestamp(1:1970),matrice(round(array*143/257):array,40));

for n=1:round(array*(143/257))
     matrice(n,41)=6;
    end
for n=round(array*(143/257)):array
    matrice(n,41)=7;
end
